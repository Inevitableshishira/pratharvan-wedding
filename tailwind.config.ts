    ...
    extend: {
      colors: {
        ...
        wedding: {
          ...
          cream: "hsl(var(--cream))",
          rose: "hsl(var(--rose))",
          /* NEW: Romantic & Sacred Wedding Colors */
      ...
      fontFamily: {
        ...
        feminine: ["'Cormorant Upright'", "serif"],
        traditional: ["'Gotu'", "serif"],
        accent: ["'Aboreto'", "cursive"],
